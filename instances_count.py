...
# label_path = Path("./final_dataset_split/train/labels/")
# counter = Counter()
...
image_dirs = [Path("./real_final_dataset/train/images"), Path("./real_final_dataset/valid/images"), Path("./real_final_dataset/test/images")]
label_dirs = [Path("./real_final_dataset/train/labels"), Path("./real_final_dataset/valid/labels"), Path("./real_final_dataset/test/labels")]
